...
public abstract class Airline {
	...
	public String toString() {
		...
		sb.append("Airline " + name + " has fleet: [");
	...
	public static void main(String[] args) {
		FlagCarriers croatiaAirlines = new FlagCarriers("Croatia Airlines",
				new String[] { "Airbus A 320 - 200", "Airbus A 319 - 100", "Dash 8-Q400" }, 60);
		...
		Regional airCanadaExpress = new Regional("Air Canada Express",
				new String[] { "Bombardier CRJ200ER", "Embraer 175" }, 15, 2);
